...
```
dependencies {
    implementation 'io.github.stefanosiano.powerful_libraries:sama:0.5.02' // Put this line into module's build.gradle
    compileOnly 'io.github.stefanosiano.powerful_libraries:sama_annotations:0.5.02' // Put this line for extended funcionalities
    kapt 'io.github.stefanosiano.powerful_libraries:sama_annotations:0.5.02' // Put this line for extended funcionalities
}
```

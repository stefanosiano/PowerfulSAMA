...
class SimpleRecyclerView: RecyclerView {
    ...
    fun unregisterAdapterDataObserver() = adapter?.unregisterAdapterDataObserver(observer)

    /** Starts observing the list adapter changes */
    fun registerAdapterDataObserver() = adapter?.registerAdapterDataObserver(observer)
